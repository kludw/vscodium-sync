...
Two-way sync of your VSCodium `settings.json` through a private GitHub gist. Auto sync is always on, and there's nothing to configure: install, sign in to GitHub once, done.
...
```sh
bun test              # run the test suite (19 tests, 100% coverage on the pure core)
